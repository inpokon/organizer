    ...
    works = [
        {
            ...
            desc: [
                'ERP-система, ориентированная на стоматологические клиники NewSmile.',
                'Приложение было разработано при помощи следующих технологий:',
                '1С-Битрикс + ReactJS.',
        ...
        },
        {
            ...
            desc: [
                ...
                'Сайт был разработан при помощи 1С-Битрикс + WebPack -> Pug, SCSS, Jquery.',
                'Над сайтом работали:',
                '1 Backend-разработчик, 3 Frontend-разработчика, 1 UI/UX Дизайнер.',
                'Моя роль составила 80% Frontend разработки.'
            ],
        ...
        },
        {
            ...
            desc: [
                'Сайт был разработан при помощи WebPack -> Pug, SCSS, Jquery.',
                'Над приложением работали:',
