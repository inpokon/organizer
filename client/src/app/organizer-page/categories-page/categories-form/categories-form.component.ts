...
export class CategoriesFormComponent implements OnInit {
    ...
    loadingImage() { // перенаправление кнопки
        this.inputImageRef.nativeElement.click();
    }

    onFileUpload(event: any) { // загрузка изображения категории
    ...
    onSubmit() {
        ...
        if (this.isNew) { // добавляем новую категорию
            obs$ = this.categoriesService.create(this.form.value.name, this.image);
        } else { // изменяем категорию
